...
function validateText(id)
{
  ...
  {
    $('.'+name+'-validate').removeClass("hide");
    return false;
  }
  else{
    $('.'+name+'-validate').addClass("hide");
    return true;
  }
...
$(document).ready(
  function()
  {
    ...
    {
      if(validateText("contactNama")&&validateEmail("contactEmail") && validateText("contactPassword") && validateText("contactInstansi") && validateText("contactPhone") && validateText("contactAlamat") && validateText("contactKota"))
      {

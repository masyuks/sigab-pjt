		...
		<div class="row pb-10" style="margin:10px">
			...
			<div class="col-12" style="padding:0;padding-bottom:10px;">
				<div class="input-group-icon mt-10">
					<input value="<?php echo $search['parameter'] ?>" type="text" name="" placeholder="Cari Stasiun" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Cari Stasiun'" required=""  class="single-input search-daerah" style="padding-left:20px;background:#f3f3f3">
					<?php if($search['parameter']==false){ ?>
					<div onclick="search_func($('.search-daerah').val())" class="icon" style="right:20px;left:inherit;cursor:pointer"><i class="fa fa-search" aria-hidden="true"></i></div>
				<?php } else{ ?>
		...
		<div class="row" style="justify-content:center">
			...
			<div class="navbar-second col-md-12 pt-10">
				...
				<div class="row pb-10">
					...
					<div class="col-12" style="padding:0;padding-bottom:10px;">
						<div class="input-group-icon mt-10">
							<input value="<?php echo $search['parameter'] ?>" type="text" name="" placeholder="Cari Stasiun" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Cari Stasiun'" required=""  class="single-input search-daerah-2" style="padding-left:20px;background:#f3f3f3">
							<?php if($search['parameter']==false){ ?>
							<div onclick="search_func($('.search-daerah-2').val())" class="icon" style="right:20px;left:inherit;cursor:pointer"><i class="fa fa-search" aria-hidden="true"></i></div>
						<?php } else{ ?>
							<a href="<?php  echo base_url('index.php/home/'); ?>">
							<div  class="icon" style="right:20px;left:inherit;cursor:pointer"><i class="fa fa-close" aria-hidden="true"></i></div>
						</a>
			...
			<div class="col-md-12 col-lg-12 pt-10 zindex-0">
				...
				<div id="mapdiv" class="maps">
					<h3 style="position: absolute;z-index: 9999;right: 35px;top:20px">Water level</h3>
				</div>
			</div>
